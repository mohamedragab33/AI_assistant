...
# 🚀 Bitcoin Trading AI - VPS Setup Script
...
sudo -u bitcoin-ai python3.9 -m venv .venv
...
# 11. Configure Nginx (basic config for now)
...
echo "1. Start services: systemctl start bitcoin-ai-auth bitcoin-ai-main"
echo "2. Check status: systemctl status bitcoin-ai-auth bitcoin-ai-main"
echo "3. Configure domain and SSL (if you have a domain)"
echo "4. Test the application at http://45.136.18.93"
echo
echo -e "${GREEN}Your Bitcoin Trading AI is ready to go live! 🚀${NC}" 